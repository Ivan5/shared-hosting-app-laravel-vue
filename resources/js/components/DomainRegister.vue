<template>
    <div>
        ...
        >
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    type="text"
                    :class="{
                        'is-invalid': form.errors.has('shortdescription')
                    }"
                    class="form-control"
                    id="inputAddress2"
            ...
            <div class="form-group">
                <label for=""
                    >Submit your website for
                    <span class="text-success">$4.99</span></label
                >
            </div>
        ...
        <div
            v-show="(showpaypal === true) & (loadding === false)"
            class="container"
        >
        ...
        <div
            v-show="(showpaypal === true) & (loadding === true)"
            class="container"
        >
            <div class="row text-center">
                <div class="w-100 text-center">
